  ...
  return (
    <section className="features-section py-12 bg-slate-50 min-h-[calc(100vh-4rem)]">
      <div className="container mx-auto px-4">
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            <div className="feature-image-wrapper hidden md:block" style={{marginBottom: 8}}>
              <img className="feature-image" src="/6 clases del Desafío Asiático.jpeg" alt="6 clases del Desafío Asiático" loading="lazy" style={{width: '100%', aspectRatio: '1/1', height: 'auto', objectFit: 'cover', display: 'block', borderTopLeftRadius: 12, borderTopRightRadius: 12}} />
            </div>
            <div className="icon-wrapper">
          ...
          <div className="feature-card">
            <div className="feature-image-wrapper" style={{marginBottom: 8}}>
              <img className="feature-image" src="/4 clases EXTREMAS de cardio quemagrasa.jpg" alt="4 clases EXTREMAS de cardio quemagrasa" loading="lazy" style={{width: '100%', aspectRatio: '1/1', height: 'auto', objectFit: 'cover', display: 'block', borderTopLeftRadius: 12, borderTopRightRadius: 12}} />
            </div>
            <div className="icon-wrapper">
          ...
          <div className="feature-card">
            <div className="feature-image-wrapper hidden md:block" style={{marginBottom: 8}}>
              <img className="feature-image" src="/Plan de alimentación personalizado.jpeg" alt="Plan de alimentación personalizado" loading="lazy" style={{width: '100%', aspectRatio: '1/1', height: 'auto', objectFit: 'cover', display: 'block', borderTopLeftRadius: 12, borderTopRightRadius: 12}} />
            </div>
            <div className="icon-wrapper">
            ...
            <h3 className="feature-title">Plan de alimentación personalizado</h3>
          ...
          <div className="feature-card">
            <div className="feature-image-wrapper hidden md:block" style={{marginBottom: 8}}>
              <img className="feature-image" src="/Sesiones exclusivas de Zumba y cardio latino.jpeg" alt="Sesiones exclusivas de Zumba y cardio latino" loading="lazy" style={{width: '100%', aspectRatio: '1/1', height: 'auto', objectFit: 'cover', display: 'block', borderTopLeftRadius: 12, borderTopRightRadius: 12}} />
            </div>
            <div className="icon-wrapper">
              <svg width="24" height="24" fill="none" stroke="#ea9b25" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 2v20M2 12h20"/><path d="M12 2l4 4M12 2l-4 4"/></svg>
            </div>
            <h3 className="feature-title">Sesiones exclusivas de Zumba y cardio latino</h3>
            <p className="feature-desc">para sudar, reír y reconectar contigo.</p>
          </div>
          {/* Mobile CTA after Zumba block, before Masterclass */}
          <div className="block md:hidden w-full text-center mt-4">
            <button
              onClick={() => window.open('https://bit.ly/Rosafitness-verano', '_blank')}
          ...
          <div className="feature-card">
            <div className="feature-image-wrapper hidden md:block" style={{marginBottom: 8}}>
              <img className="feature-image" src="/Masterclass de hábitos duraderos.jpg" alt="Masterclass de hábitos duraderos" loading="lazy" style={{width: '100%', aspectRatio: '1/1', height: 'auto', objectFit: 'cover', display: 'block', borderTopLeftRadius: 12, borderTopRightRadius: 12}} />
            </div>
            <div className="icon-wrapper">
        ...
        <div className="text-center pt-3" style={{ marginBottom: '2rem' }}>
          <div className="hidden md:block mb-2">
            <span style={{ fontSize: '1.1rem', color: '#ea9b25', opacity: 0.95, fontWeight: 600 }}>
              Olvídate de dietas y entrenamientos muy difíciles de seguir y muy fáciles de abandonar.
            </span>
          </div>
          <div className="block md:hidden mb-2">
            <span style={{ fontSize: '1rem', color: '#ea9b25', opacity: 0.95, fontWeight: 600 }}>
              Olvídate de dietas y entrenamientos muy difíciles de seguir y muy fáciles de abandonar.
            </span>
          </div>
          <button
