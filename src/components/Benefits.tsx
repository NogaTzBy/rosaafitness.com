    ...
    <section className="features-section py-12 bg-slate-50 min-h-[calc(100vh-4rem)]">
      <div className="container mx-auto px-4">
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            <div className="feature-image-wrapper hidden md:block" style={{marginBottom: 8}}>
              <img className="feature-image" src="/comiendo.jpg" alt="Plan de alimentación personalizado" loading="lazy" style={{width: '100%', aspectRatio: '1/1', height: 'auto', objectFit: 'cover', display: 'block', borderTopLeftRadius: 12, borderTopRightRadius: 12}} />
            </div>
            <div className="icon-wrapper">
