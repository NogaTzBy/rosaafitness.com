...
const Hero = () => {
  const handleWhatsAppClick = () => {
    window.open('https://bit.ly/Rosafitness-verano', '_blank');
  };
      ...
      <div className="relative min-h-screen md:min-h-screen container mx-auto px-6 flex items-center">
        <div className="max-w-2xl mx-auto text-center header-container mt-0 md:mt-0">
          <div className="pt-0 pb-1 md:pt-16 md:pb-8">
            ...
            <div className="sub-note mb-6">
              <span className="text-brand-300 font-semibold">Aunque estés embarazada</span><br />
              <span className="text-brand-300 font-semibold">Aunque tengas poco tiempo</span>
            </div>
          </div>
